...
class TransactionListItem(
    ...
    inner class ViewHolder(
        ...
        private fun setTexts(transaction: WalletTransaction, isCryptoPreferred: Boolean) {
            ...
            tx_date.text = com.cryptron.tools.util.BRDateUtil.getShortDate(timeStamp)
        }
        ...
        private fun showTransactionProgress(progress: Int) {
            ...
            if (progress < PROGRESS_FULL) {
                ...
                tx_description.maxWidth = com.cryptron.tools.util.Utils.getPixelsFromDps(context, DP_120)
                tx_description.layoutParams = RelativeLayout.LayoutParams(
                    ...
                    setMargins(
                        com.cryptron.tools.util.Utils.getPixelsFromDps(context, DP_16),
                        com.cryptron.tools.util.Utils.getPixelsFromDps(context, DP_36),
                        0,
                        0
                    )
                }
        ...
        private fun showTransactionFailed(tx: WalletTransaction, received: Boolean) {
            ...
            tx_description.layoutParams =
                RelativeLayout.LayoutParams(
                    ...
                    addRule(RelativeLayout.CENTER_VERTICAL)
                    setMargins(com.cryptron.tools.util.Utils.getPixelsFromDps(context, DP_16), 0, 0, 0)
                }
