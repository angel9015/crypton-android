package com.cryptron.legacy.presenter.fragments;
...
import com.cryptron.protocols.messageexchange.MessageExchangeNetworkHelper;
...
import com.cryptron.protocols.messageexchange.entities.ServiceMetaData;
...
import static com.cryptron.tools.util.BRConstants.STRING_RESOURCES_FILENAME;
...
public class FragmentLinkWallet extends Fragment {
    ...
    private String getLocalizedStringFromKey(String key) {
        ...
        int resId = getResources().getIdentifier(key, BRConstants.STRING_RESOURCES_FILENAME, packageName);
